...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('core_image', 'year_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Year'], null=True))

    def backwards(self, orm):

        # Changing field 'Image.year'
        db.alter_column('core_image', 'year_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['core.Year']))
